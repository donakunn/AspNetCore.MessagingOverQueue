...
/// </summary>
public sealed partial class DefaultTopologyNamingConvention : ITopologyNamingConvention
{
    private readonly TopologyNamingOptions _options;
    ...
    public DefaultTopologyNamingConvention(TopologyNamingOptions options)
    {
